...
public class SimpleBot {
    ...
    final Map<String, String> PATTERNS_FOR_ANALYSIS = new HashMap<String, String>() {{
        ...
        //gamenumber
        put("число\\s.*больше", "gamenumber");
        put("сыграем\\s.*числа", "gamenumber");
        // bye
        put("прощай", "bye");
        put("увидимся", "bye");
    ...
    /**
     *  Создали Исупова Лейсан, Вешкина Ирина и Тетюшин Семён
     */

    final Map<String, String> ANSWERS_BY_PATTERNS = new HashMap<String, String>() {{
        put("hello", "Здравствуйте, рад Вас видеть.");
        put("who", "Я обычный чат-бот.");
        put("name", "Зовите меня Дэб :)");
    ...
    /**
     *  Конструктор SimpleBot() создал Тетюшин Семён
     */
    ...
    /**
     *  Метод sayInReturn() создал Венисяцкий Сергей
     */
        ...
        if (ai) {
            ...
            for (Map.Entry<String, String> o : PATTERNS_FOR_ANALYSIS.entrySet()) {
                ...
                if (pattern.matcher(message).find())
                    ...
                    else if(o.getValue().equals("gamenumber")){
                        if (test1(msg)){
                            return "Давай, моё число: " + randomNum();
                        } else {
                            return "Вы хотите меня обмануть. Введите число, чтобы сыграть ос мной!";
                        }
                    } else {
    ...
    /**
     *  Метод test1() создал Венисяцкий Сергей
     */

    public static boolean test1(String testString){
        Pattern p = Pattern.compile(".*?\\b([1-9][0-9]?|100)\\b.*?");
        Matcher m = p.matcher(testString);
        return m.matches();
    }

    /**
     *  Метод randomNum() создал Венисяцкий Сергей
     */
